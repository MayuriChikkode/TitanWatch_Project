        ...
        <div class="col mb-2">
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <a href="product.php" class="btn btn-block btn-light"><i class="fa fa-shopping-cart"></i> Continue Shopping</a>
                </div>
                <div class="col-sm-12 col-md-6 text-right">
                    <a href="hms/user-login1.php" class="btn btn-md btn-block btn-success text-uppercase <?=($grand_total > 1)?'':'disabled';?>">Checkout</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        $('.itemQty').on("change", function(){
            ...
            // Validate quantity: it must be greater than 0
            if(qty <= 0) {
                alert("Quantity must be at least 1.");
                $(this).val(1);  // Reset the quantity to 1
                qty = 1;  // Assign 1 to qty
            }
