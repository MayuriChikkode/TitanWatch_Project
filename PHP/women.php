...
?>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="images/womenslide.webp" class="d-block w-100" alt="...">
                  </div>
                </div>
            </div>
        </div>
 ...
 <div class="section4">
    ...
    <div class="row">
      ...
      font-size: 30px;
      font-weight:550; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">Women's Watches</span>
    </div>
